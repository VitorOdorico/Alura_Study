...
let resposta = window.alert(`Olá ${nome}, você tem ${idade} anos e já está aprendendo ${linguagem}!`)

let operation = prompt(`Você gosta de estudar ${linguagem}? Responda com o número 1 para SIM ou 2 para NÃO.`)
if(operation == 1){
